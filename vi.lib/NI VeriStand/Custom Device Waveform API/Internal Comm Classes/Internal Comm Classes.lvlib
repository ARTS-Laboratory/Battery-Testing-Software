...
<Library LVVersion="20008000">
	<Property Name="NI.Lib.FriendGUID" Type="Str">e969ae76-b377-4ff0-9875-5b60a8e0b63c</Property>
	...
	<Item Name="WPL" Type="Folder">
		<Property Name="NI.SortType" Type="Int">3</Property>
		<Item Name="WPL Comm (1D DBL).lvclass" Type="LVClass" URL="../WPL Comm/WPL Comm (1D DBL)/WPL Comm (1D DBL).lvclass"/>
		<Item Name="WPL Comm (2D DBL).lvclass" Type="LVClass" URL="../WPL Comm/WPL Comm (2D DBL)/WPL Comm (2D DBL).lvclass"/>
		<Item Name="WPL Comm (1D CDB).lvclass" Type="LVClass" URL="../WPL Comm/WPL Comm (1D CDB)/WPL Comm (1D CDB).lvclass"/>
		<Item Name="WPL Comm (2D CDB).lvclass" Type="LVClass" URL="../WPL Comm/WPL Comm (2D CDB)/WPL Comm (2D CDB).lvclass"/>
		<Item Name="WPL Comm.lvclass" Type="LVClass" URL="../WPL Comm/WPL Comm.lvclass"/>
	</Item>
</Library>
